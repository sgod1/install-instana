...
check_for_key "CLICKHOUSE_DEFAULT_PASS" "$CLICKHOUSE_DEFAULT_PASS"
...
check_for_key "CORE_CONFIG_SMTP_USER" "$CORE_CONFIG_SMTP_USER"
check_for_key "CORE_CONFIG_SMTP_PASSWORD" "$CORE_CONFIG_SMTP_PASSWORD"
fi
